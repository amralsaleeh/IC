        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">الخطط التدريبية</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard">الإدارة العامة</a></li>
                                <li class="breadcrumb-item active">الخطط التدريبية</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    <div class="d-flex justify-content-end">
                        <button class="btn btn-primary">
                            <i class="fa-solid fa-circle-plus mx-50"></i> خطة  تدريبية جديدة
                        </button>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body d-flex">
                                ...
                                <div class="col-6 p-1">
                                    <label class="form-label" for="basicSelect">النوع</label>
                                    <select class="form-select" id="basicSelect">
                                        <option>الكل</option>
                                        <option>تضخيم</option>
                                        <option>تنشيف</option>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th style="border-radius: 0px 10px 0px 0px;">أسم الخطة</th>
                                            <th>الجنس</th>
                                            <th>النوع</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="fa-solid fa-mars" style="color: #3CA2C8;"></a>
                                                <a class="fa-solid fa-venus" style="color: #DB4C77;"></a>
                                            </td>
                                            <td>
                                                تضخيم
                                            </td>
