            ...
            <div class="row">
                    ...
                    <form class="validate-form mt-2 pt-50">
                      <div class="row">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <select class="hide-search form-select">
                        ...
                        <div class="col-12 col-sm-6 mb-1">
                            ...
                            <input type="text" id="fp-default" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" value="2022-10-1" />
                        </div>
                        <div class="col-12 col-sm-6 mb-1">
                      ...
                      <br>
                        ...
                        <div class="col-12" style="text-align: center">
                            <button type="button" class="btn btn-primary mt-1 me-1" id="save_personal_information">حفظ</button>
                        </div>
                    </form>
                      ...
                      <form class="validate-form mt-2 pt-50">
                        <div class="row">
                          ...
                          <div class="col-12 col-sm-6 mb-1">
                            ...
                            <select select class="select2 form-select" multiple>
                        ...
                        <hr style="margin: 0% 15%;">
                        <div class="col-12" style="text-align: center">
                            <button type="button" class="btn btn-primary mt-1 me-1" id="save_sports_information">حفظ</button>
                        </div>
                      </form>
                ...
                <div class="card">
                    ...
                    <form class="validate-form mt-2 pt-50">
                        ...
                        <hr style="margin: 0% 15%;">
                        <div class="col-12" style="text-align: center">
                            <button type="button" class="btn btn-primary mt-1 me-1" id="save_goals_information">حفظ</button>
                        </div>
                    </form>
                    </div>
                </div>
