...
class Dashboard extends Component
{
    ...
    public function mount()
    {
        ...
        $this->expirationPercentage = [round(100 - Carbon::parse($this->subscriptionLast->expiration_date)->diff(Carbon::now()->toDateTimeString())->days * 100 / ($this->subscriptionLast->duration * 30), 0)];
        // dd($this->expirationPercentage);
