...
$(function () {
    ...
    var handlesSlider = document.getElementById('slider-handles'),
      ...
      TrainingCommitment = document.getElementById('training-commitment'),
      DietaryCommitment = document.getElementById('dietary-commitment');
    ...
    if (typeof TrainingCommitment !== undefined && TrainingCommitment !== null) {
      // Range
      noUiSlider.create(TrainingCommitment, {
        start: 80,
        step: 10,
        range: {
          min: 0,
    ...
    if (typeof DietaryCommitment !== undefined && DietaryCommitment !== null) {
      // Range
      noUiSlider.create(DietaryCommitment, {
        start: 50,
        step: 10,
        range: {
          min: 0,
